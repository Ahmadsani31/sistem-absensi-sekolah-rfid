...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900">
    <div id="app" class="min-h-screen flex">
        <!-- Sidebar -->
        <div id="sidebar"
            class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
            <!-- Sidebar Header -->
                ...
                <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex-1 lg:flex lg:items-center lg:justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <!-- Current time -->
                            <x-digital-clock class="bg-blue-600/15" />
